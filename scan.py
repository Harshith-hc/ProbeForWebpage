...
# Usage      : python3 <scan.py> <domainname>
...
|  __/| | | (_) | |_) |  __/  _| (_) | |   \ V  V /  __/ |_) |
|_|   |_|  \___/|_.__/ \___|_|  \___/|_|    \_/\_/ \___|_.__/ 
{bcolors.ENDC}      (The ProbeForWeb Vulnerability Scanner By Gowtham)
            ...
            while self.busy:
                if not self.disabled:
                    ...
                    if inc>random.uniform(0,terminal_size()): #30 init
                        print(end="\r")
                        bcolors.BG_SCAN_TXT_START = '\x1b[6;30;'+str(round(random.uniform(46,47)))+'m'
